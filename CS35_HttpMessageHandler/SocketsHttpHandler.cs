...
{
    public class SocketsHttpHandlerMethod
    {
        ...
        public static async Task Run()
        {
            ...
            handler.UseCookies = true;                              // ? Cho phép lưu cookie vào CookieContainer không
            ...
            Console.WriteLine("SocketsHttpHandlerMethod - Cookie:");
